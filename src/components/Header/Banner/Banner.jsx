...
const Banner = () => {
    return (
        <div className="">
            <div className="" style={{ backgroundImage: "url(https://i.ibb.co/Jsqy6BN/01ed21a1-3c35-4a0a-aada-5af1a5ecb7c7.jpg)", backgroundRepeat: "no-repeat", backgroundSize: "cover", height: "700px" }}>
                ...
                <div >
                    ...
                    <div className="relative flex h-14 w-full min-w-[200px] max-w-[48rem] block mx-auto mt-10">
                        ...
                        />
                        <button
                            className="!absolute right-1 top-1 z-10 select-none rounded bg-red-600 py-2 px-4 text-center align-middle font-sans text-lg font-medium uppercase text-white  shadow-pink-500/20 transition-all hover:shadow-lg hover:shadow-black focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none peer-placeholder-shown:pointer-events-none peer-placeholder-shown:bg-blue-gray-500 peer-placeholder-shown:opacity-50 peer-placeholder-shown:shadow-none"
                            type="button"
